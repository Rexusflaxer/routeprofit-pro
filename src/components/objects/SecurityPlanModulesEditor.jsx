...
export default function SecurityPlanModulesEditor({ modules = [], value = [], onChange }) {
  ...
  const addModule = module => onChange([...assignments, { id: createSecurityPlanClientId("module"), sequence: assignments.length + 1, module_id: module.id, module_revision_id: module.current_published_revision_id, access_mode: "register", quick_action: false, instruction: "" }]);
  ...
  return <section className="overflow-hidden rounded-xl border border-border/70 bg-card/45 shadow-sm backdrop-blur-xl">
