...
export const ALARM_SYSTEM_BRAND_OPTIONS = [
  ...
  alarmBrand({ value: "Comelit", slug: "comelit", productFamilies: ["VEDO"], logoBackground: "dark" }),
  ...
  alarmBrand({ value: "Ksenia Security", slug: "ksenia-security", productFamilies: ["lares 4.0"], aliases: ["Ksenia"], logoBackground: "dark" }),
  ...
  alarmBrand({ value: "Radionix", slug: "radionix", productFamilies: ["G Series", "B Series"], status: "transition", note: "Het actuele intrusion-merk van KEENFINITY.", logoBackground: "dark" }),
  alarmBrand({ value: "RISCO", slug: "risco", productFamilies: ["LightSYS", "ProSYS Plus", "WiComm Pro"], aliases: ["Risco", "Rokonet"], logoBackground: "dark" }),
