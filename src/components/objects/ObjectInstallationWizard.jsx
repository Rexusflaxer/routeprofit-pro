    ...
    <Field label={definition.label} htmlFor={`installation-${definition.key}`} hint={revoked ? "Deze code wordt na opslaan veilig ingetrokken en als wijziging gelogd." : alreadySet && !value ? "Er is al een code ingesteld. Laat leeg om deze ongewijzigd te bewaren." : definition.description}>
      <div className="space-y-2">
        <div className="relative">
          ...
          <Input id={`installation-${definition.key}`} type={visible ? "text" : "password"} value={value || ""} onChange={event => onChange(event.target.value)} disabled={revoked} className="pl-9 pr-10" autoComplete="off" data-lpignore="true" data-1p-ignore="true" placeholder={revoked ? "Code wordt ingetrokken" : alreadySet ? "Bestaande code behouden" : "Optioneel"} maxLength={128} />
