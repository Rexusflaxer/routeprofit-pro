...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-xl border border-border/60 bg-card/45 p-1 text-muted-foreground shadow-sm backdrop-blur-xl",
      className
    )}
    {...props} />
))
