  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center px-4 py-2 border-b border-border bg-muted/30 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
        ...
        {!showForm && !deleteId && (
          <Button size="sm" variant="outline" onClick={openNew} className="h-7 px-2 text-xs font-medium normal-case tracking-normal shrink-0">
      ...
      <div className="divide-y divide-border">
        {accreditations.map(item => (
          <div key={item.id} className="flex items-center px-4 py-3 group hover:bg-accent/30 transition-colors">
            ...
            <div className="shrink-0 flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
