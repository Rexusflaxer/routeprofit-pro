...
export default function PlanningClipboardContextMenu({
  children, mode, available, disabled, detail, label, onSelect, secondaryLabel, secondaryDisabled, onSecondarySelect,
}) {
    ...
    <ContextMenu>
      ...
      <ContextMenuContent className="w-60">
        ...
        <ContextMenuItem disabled={disabled} onSelect={onSelect} className="gap-2 text-[12px]">
          ...
          {label || (isCopy ? "Dienst kopiëren" : "Dienst hier plakken")}
        </ContextMenuItem>
        {secondaryLabel && (
          <ContextMenuItem disabled={secondaryDisabled} onSelect={onSecondarySelect} className="gap-2 text-[12px]">
